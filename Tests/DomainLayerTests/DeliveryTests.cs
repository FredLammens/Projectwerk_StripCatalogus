...
namespace Tests.DomainLayerTests
{
    ...
    public class DeliveryTests
    {
        ...
        public void CheckSetOrderComicsTest()
        {
            ...
            b.Should().Throw<ArgumentException>().WithMessage($"hoeveelheid: {orderComics2.First().Value} overschrijdt de hoeveelheid van {orderComics2.First().Key.Title}: {orderComics2.First().Key.AmountAvailable}.");
        }
        // delivery => id??
        [TestMethod]
        public void CheckAmountNotNegative()
        {
            ...
            Action a = () => new Delivery(1, date, dateDelivery, orderComics1);
            a.Should().NotThrow<ArgumentException>();
            Action b = () => new Delivery(1, date, dateDelivery, orderComics2);
        ...
        {
            DateTime date = new DateTime(2019, 12, 01, 10, 00, 00);
            DateTime dateDelivery = new DateTime(2021, 12, 10, 10, 00, 00);
            ...
            Action a = () => new Delivery(1, date, dateDelivery, orderComics1);
            a.Should().NotThrow<ArgumentException>();
            Action b = () => new Delivery(1, date, dateDeliveryInPast, orderComics2);
